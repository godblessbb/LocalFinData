...
# FinRL®: Financial Reinforcement Learning (US Stock Trading Edition) [![twitter][1.1]][1] [![facebook][1.2]][2] [![google+][1.3]][3] [![linkedin][1.4]][4]

> **Note**: This is a streamlined version of FinRL focused exclusively on **US Stock Market Strategy Training and Backtesting**.
>
> **Removed**: Cryptocurrency trading, high-frequency trading, imitation learning, portfolio allocation
>
> **Focus**: AI-powered strategy training with DRL algorithms (PPO, A2C, SAC, DDPG, TD3) for US equities
...
```
FinRL (US Stock Trading Edition)
├── finrl (main folder)
│   ├── applications
│   	├── Stock_NeurIPS2018      # Tutorial notebooks for stock trading
│   	└── stock_trading          # Stock trading examples
│   ├── agents
│   	├── elegantrl              # ElegantRL DRL algorithms
│   	├── rllib                  # Ray RLlib integration
│   	└── stablebaselines3       # Stable Baselines3 (A2C, PPO, DDPG, TD3, SAC)
│   ├── meta
│   	├── data_processors        # Yahoo Finance, Alpaca, WRDS processors
│   	├── env_stock_trading      # Stock trading environments (with stop-loss, cash penalty, etc.)
│   	├── preprocessor           # Feature engineering & technical indicators
│   	├── paper_trading          # Paper trading with Alpaca
│   	├── data_processor.py
│   	└── meta_config.py
│   ├── config.py                  # Configuration & hyperparameters
│   ├── config_tickers.py          # DOW 30, NASDAQ 100 ticker lists
│   ├── main.py                    # Main entry point
│   ├── plot.py                    # Visualization tools
│   ├── train.py                   # Training pipeline
│   ├── test.py                    # Backtesting pipeline
│   └── trade.py                   # Live/paper trading
│
...
## Supported Data Sources (US Stock Market Focus)
